...
N = int(sys.argv[1])  # Define o tamanho N das matrizes quadradas (200x200).
...
print(f"Tempo de execução para a multiplicação de matrizes: {end_time - start_time:.2f} segundos ({N}x{N})")
